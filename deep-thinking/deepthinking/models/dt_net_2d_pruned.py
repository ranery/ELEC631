...
from .masked_blocks import BasicBlock2D as BasicBlock
from .masked_layers import Conv2d
...
class DTNet(nn.Module):
    ...
    def __init__(self, block, num_blocks, width, in_channels=3, recall=True, group_norm=False, **kwargs):
        ...
        conv_recall = Conv2d(width + in_channels, width, kernel_size=3,
                                stride=1, padding=1, bias=False)
        ...
        head_conv1 = Conv2d(width, 32, kernel_size=3,
                               stride=1, padding=1, bias=False)
